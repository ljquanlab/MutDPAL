...
def get_args():
    ...
    parser.add_argument('--save_path', type=str, default='../model_state/train_best.pth', help='Path to save the model')  #模型权重
    parser.add_argument('--output_path', type=str, default='../model_state/test_logs.txt', help='Path to save the model')
