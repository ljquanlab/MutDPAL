...
def get_args():
    ...
    # Dataset and paths
    parser.add_argument('--data_dir', type=str, default='../../data', help='Path to dataset')     #数据路径
    parser.add_argument('--save_path', type=str, default='../../model_state/train_best_m.pth', help='Path to save the model')  #模型权重
    parser.add_argument('--output_path', type=str, default='../../model_state/test_logs_m.txt', help='Path to save the model')
    ...
    parser.add_argument('--num_classes', type=int, default=15, help='Number of output classes')
